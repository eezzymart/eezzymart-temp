      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group relative bg-white rounded-2xl p-5 md:p-6 border border-gray-100 hover:border-transparent hover:shadow-2xl hover:shadow-black/5 transition-all duration-500 text-center hover:-translate-y-1"
            >
              ...
              <h3 className="font-bold text-sm md:text-base text-gray-800 mb-1 group-hover:text-gray-900">
                {feature.title}
              </h3>
